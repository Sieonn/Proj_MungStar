      ...
      <div class="signup-container">
        ...
        <div class="field">
          ...
          <div class="inner-input">
            ...
            <button  id="doubleId" name="doubleId" >중복조회</button>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="inner-input2">
            ...
            <div class="inner-input">
              <input type="text" id="memAddress1" name="memAddress1"placeholder="주소"  />
              <input type="text" id="memAddress2" name="memAddress2"placeholder="상세주소" />
            </div>
          </div>
        </div>
      </div>
