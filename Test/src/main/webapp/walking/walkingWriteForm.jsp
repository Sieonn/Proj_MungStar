				...
				<div class="walkDetail">
					...
					<div id="walkContent">
						<div class="walkSubject">
							<input type="text" placeholder="장소 이름을 입력해 주세요">
						</div>
						<div id="walkPhoto">
							<label class="walkPhotoButton" for="walkPhotoBtn">
								+
							</label>
							<input type="file" id="walkPhotoBtn">
							<h2>선택 사항</h2>
						</div>
						<br>
						<br>
						...
						<div class="walkAddress">
							<div id="detailAddress">
								<img src="<%=request.getContextPath()%>/image/place.png"
									width="20px"> <input type="text" placeholder="주소를 입력하세요">
							</div>
						</div>
					</div>
					...
					<div class="walkReason">
						<h2>추천 이유</h2>
						<input type="text" placeholder="해당 장소를 추천하는 이유를 적어 주세요">
					</div>
