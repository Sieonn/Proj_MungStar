...
<body>
	...
	<div class="pageContainer">
		<form id="freeWrite" method="post" enctype="multipart/form-data"
			action="${path}/freeBoard/freeWriteForm">
			<div class="freeContainer">
				...
				<div class="writeContainer">
					<input class="writeTitle" id="freeSub" name="freeSub" type="text"
						placeholder="  제목  " required="required" /> <br>
					<div class="content">
						<div class="toolbar">
							...
							<img src="../image/b.png" class="imgBtn2 "
								onclick="document.execCommand('bold', false, null);"> <img
								src="../image/italic.png" class="imgBtn2 "
								onclick="document.execCommand('italic', false, null);"> <img
								src="../image/underline.png" class="imgBtn2 "
								onclick="document.execCommand('underline', false, '');"> <img
								src="../image/line.png" class="imgBtn2 "
								onclick="document.execCommand('strikeThrough', false, '');">
							<img src="../image/quote.png" class="imgBtn"
								onclick="quoteText()">
							<div class="imgBtn"></div>
							<img src="../image/image.png" class="imgBtn"
								onclick="document.getElementById('fileInput').click()"> <input
								type="file" id="fileInput" id="freePhoto" name="file"
								style="display: none;" accept="image/*"
								onchange="handleFiles(event)"> <img
								src="../image/link-icon.png" class="imgBtn"
								style="width: auto; hight: 50%;" onclick="addLink()">
							<div class="imgBtn"></div>
							<img src="../image/왼쪽정렬.png" class="imgBtn"
								onclick="document.execCommand('justifyLeft', false, '');">
							<img src="../image/가운데정렬.png" class="imgBtn"
								onclick="document.execCommand('justifyCenter', false, '');">
							<img src="../image/오른쪽정렬.png" class="imgBtn"
						...
						<div class="scroll-box">
							...
							<div id="editor" class="text-area" contenteditable="true"
								style="overflow: hidden; width: 100%;"></div>
						</div>
						<input type="text" class="tag-input" id="tag" name="freeTag"
