...
//검색 버튼 클릭 시 검색 기능 구현
 ...
 function displaySearchResults(results) {
	// 결과를 JSON 형식으로 파싱
	    ...
	    // 각 검색 결과를 반복하여 화면에 추가
	    for (var i = 0; i < searchResults.length; i++) {
	        var result = searchResults[i];
	        
	        // 각 결과를 표시할 HTML 요소 생성
 ...
 /*이 함수는 검색 버튼이 클릭되면 입력된 검색어를 가져와서 search?q=와 함께 AJAX 요청을 보내고, 서버에서 받아온 응답을 처리하는 기능을 수행합니다.
그리고 displaySearchResults() 함수는 서버에서 받아온 검색 결과를 화면에 표시하는데 사용됩니다.*/
