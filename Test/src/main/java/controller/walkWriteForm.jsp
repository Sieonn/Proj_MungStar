...
<div id="leftDiv">
		<div class="backWalkDetail">
			<a href="walkBoard"id="exitBtn">
				X</a>
			<section id="./walkWriteForm">
			<div class="frontWalkDetail">
			<form action="walkWriteForm" method="post"  name="walkWriteForm">
				<div class="walkDetail">
					...
					<div id="walkContent">
						...
						<div class="walkType">
									<input id="walkAddress" type="button" onclick="daumPostcode()" value="주소 찾기">
							</div>
					</div>
					<div id="walkMidEmpty"></div>
					<div class="walkReason">
						<h2>추천 이유</h2>
						<input type="text" id="walkReason" name="walkReason" placeholder="해당 장소를 추천하는 이유를 적어 주세요">
					</div>
