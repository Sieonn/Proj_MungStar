...
public class FreeDAOImpl implements FreeDAO {
	...
	@Override
	public int selectBoardCountByQuery(String query) {
		return sqlSession.selectOne("mapper.board.selectBoardCountByQuery", query);
	}

	@Override
	public List<fBoard> searchBoardListByQuery(String query, int row) throws Exception {
		RowBounds rowBounds = new RowBounds(row, 10); // Assuming 10 rows per page
        return sqlSession.selectList("mapper.board.searchBoardListByQuery", query, rowBounds);
	}
